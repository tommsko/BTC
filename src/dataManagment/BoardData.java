...
public class BoardData {
    ...
    public BoardData(int ID, int boardID, String contractType, int contractSize, String contractLine,char contractDeclarer, int contractResult, String leadType, String leadCard, int table, int round, int NS, int EW) {
    this.ID = ID;
